...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        initPanoramaViewer();
        initEventListeners();
        // loadExistingHotspots(); // Moved to 'load' event
    });
    ...
    function initPanoramaViewer() {
        viewer = pannellum.viewer('panorama-viewer', {
            ...
            hotSpotDebug: false,
            hotSpots: [] // Explicitly initialize
        });

        // Wait for viewer to load before adding hotspots
        viewer.on('load', function () {
            console.log('Pannellum loaded, adding hotspots...');
    ...
    function addHotspotToViewer(pitch, yaw, text, type) {
        ...
        try {
            console.log('Adding hotspot to viewer at:', pitch, yaw);
            viewer.addHotSpot({
                pitch: pitch,
                yaw: yaw,
                cssClass: cssClass,
            ...
            console.error('Error in viewer.addHotSpot:', e);
            // Fallback: Try re-initializing or just log
        }
    }
